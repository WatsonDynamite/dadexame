...
class TicTacToeGame {
    ...
    uploadGameOnCreate(){
        ...
        var self = this;
          axios.post('http://188.186.86.13/api/games',
			{
    ...
    startGame(){
        if(this.playerCount > 1){
            if(this.gameStarted == false){
                ...
                var axios = require('axios');
                var self = this;
                axios.patch('http://188.186.86.13/api/games/' + self.idInDB + '/startGame')
                .then(response=> {
        ...
        for(var i = 0; i < this.playerCount; i++){
            ...
            switch(i){
                case 0:
                   ...
                   axios.post('http://188.186.86.13/api/games/' + this.idInDB + '/registerGameUser',
                    {
                    user: self.player1,
                    is_winner: isWinner
                    });
